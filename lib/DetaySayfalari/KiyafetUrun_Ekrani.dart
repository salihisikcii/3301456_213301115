...
class KiyafetUrunEkrani extends StatefulWidget {
  static const String pagename = '/KiyafetUrunEkrani';
  @override
  String isim;
  String foto;
  String fiyat;
  ...
  State<KiyafetUrunEkrani> createState() => _KiyafetUrunEkraniState();
}

class _KiyafetUrunEkraniState extends State<KiyafetUrunEkrani> {
  int adet = 0;

  Set<Sizes> selection = <Sizes>{Sizes.medium};
  @override
